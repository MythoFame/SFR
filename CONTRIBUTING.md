...
- [Speeding up loading times](CONTRIBUTING.md#speeding-up-loading-times)
...
The SFR mod is composed by many files and folders, here's a general overview of the project **outdated**.
